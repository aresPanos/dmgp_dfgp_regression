...
ax[1].plot(x_train, y_train, 'kx', markersize=8, markeredgewidth=2)
ax[1].plot(x_test, y_test, 'r', linewidth=2)
...
ax[2].plot(x_train, y_train, 'kx', markersize=8, markeredgewidth=2)
ax[2].plot(x_test, y_test, 'r', linewidth=2)
